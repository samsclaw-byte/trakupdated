...
export type SquadEventType = 'perfect_day' | 'calorie_target_hit' | 'streak_3' | 'streak_5' | 'streak_10' | 'streak_21' | 'streak_30' | 'streak_50' | 'streak_100' | 'joined' | 'habit_completed' | 'workout_completed';
